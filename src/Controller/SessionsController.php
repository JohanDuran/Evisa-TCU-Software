...
class SessionsController extends AppController
{
    ...
    public function add()
    {
        ...
        $groups = $this->Sessions->Groups->find('list', ['limit' => 200]);
        $people = $this->Sessions->People->find('list', ['limit' => 200]);
        $this->set(compact('session', 'groups', 'people'));
        $this->set('_serialize', ['session']);
    }
